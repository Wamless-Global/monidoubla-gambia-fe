...
export default function HeroSection() {
	...
	return (
		<>
			<section className="py-16 sm:py-24 bg-gray-100 dark:bg-gray-800 mt-16">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
						...
						<div className="relative">
							<img src="/images/hero.png" alt="Community giving illustration" className="w-full h-auto rounded-xl shadow-xl" />
