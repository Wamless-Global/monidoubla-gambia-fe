...
interface GHRequestsFiltersProps {
	searchTerm: string;
...
export default function GHRequestsFilters({ searchTerm, setSearchTerm, statusFilter, setStatusFilter, locationFilter, setLocationFilter, sortBy, setSortBy, resetFilters }: GHRequestsFiltersProps) {
	return (
