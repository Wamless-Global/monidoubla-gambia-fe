...
export default function AdminDashboard() {
	...
	const statCards = [
		...
		{
			title: 'Total PH Requests',
			value: loading ? '...' : error ? 'Error' : stats?.totalPhRequests?.toLocaleString() ?? '0',
		...
		{
			title: 'Total GH Requests',
			value: loading ? '...' : error ? 'Error' : stats?.totalGhRequests?.toLocaleString() ?? '0',
